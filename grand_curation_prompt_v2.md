...
## 🚫 Phase 9: The Anti-Slop Protocol (Human Voice Enforcement)
To pass the Turing Test of readability, specific "LLM-isms" are strictly banned:
## 🚫 Phase 9: The Anti-Slop & Precision Protocol
To pass the Turing Test of readability, enforce "The Hemingway Rule":
1.  **Banned Words**: "Delve", "Showcase", "Underscore", "Testament", "Rich tapestry", "Landscape".
2.  **Banned "Hedging"**:
    - *Wrong*: "It is worth noting that this might suggest..."
    - *Right*: "This suggests..." (Be definitive).
3.  **Active Voice Mandat**:
    - *Wrong*: "The data was analyzed by the system."
    - *Right*: "The system analyzed the data."
4.  **The "So What?" Rule**: Never end a section with a generic summary. End with a provocation.
